 ...
 */
export function make_receiving_address(private_key: Uint8Array, key_index: number): Uint8Array;
/**
 ...
 */
export function make_change_address(private_key: Uint8Array, key_index: number): Uint8Array;
/**
 ...
 */
export function pubkey_to_pubkeyhash_address(public_key: Uint8Array, network: Network): string;
/**
 ...
 */
export function extended_public_key_from_extended_private_key(private_key: Uint8Array): Uint8Array;
/**
 * From an extended public key create a receiving public key for a given key index
 * derivation path: current_derivation_path/0/key_index
 */
export function make_receiving_address_public_key(extended_public_key: Uint8Array, key_index: number): Uint8Array;
/**
 * From an extended public key create a change public key for a given key index
 * derivation path: current_derivation_path/1/key_index
 */
export function make_change_address_public_key(extended_public_key: Uint8Array, key_index: number): Uint8Array;
/**
 ...
 */
export function make_transaction_intent_message_to_sign(intent: string, transaction_id: string): Uint8Array;
/**
 ...
 */
export function encode_signed_transaction_intent(signed_message: Uint8Array, signatures: Uint8Array[]): Uint8Array;
/**
 ...
 */
export function verify_transaction_intent(expected_signed_message: Uint8Array, encoded_signed_intent: Uint8Array, input_destinations: string[], network: Network): void;
/**
 ...
 */
export function get_token_id(inputs: Uint8Array, current_block_height: bigint, network: Network): string;
/**
 ...
 */
export function extract_htlc_secret(signed_tx: Uint8Array, strict_byte_size: boolean, htlc_outpoint_source_id: Uint8Array, htlc_output_index: number): Uint8Array;
/**
 ...
 */
export function encode_witness(sighashtype: SignatureHashType, private_key: Uint8Array, input_owner_destination: string, transaction: Uint8Array, input_utxos: Uint8Array, input_index: number, additional_info: TxAdditionalInfo, current_block_height: bigint, network: Network): Uint8Array;
/**
 ...
 */
export function encode_witness_htlc_secret(sighashtype: SignatureHashType, private_key: Uint8Array, input_owner_destination: string, transaction: Uint8Array, input_utxos: Uint8Array, input_index: number, secret: Uint8Array, additional_info: TxAdditionalInfo, current_block_height: bigint, network: Network): Uint8Array;
/**
 ...
 */
export function encode_multisig_challenge(public_keys: Uint8Array, min_required_signatures: number, network: Network): Uint8Array;
/**
 * Produce a multisig address given a multisig challenge.
 */
export function multisig_challenge_to_address(multisig_challenge: Uint8Array, network: Network): string;
/**
 ...
 * `input_utxos` and `additional_info` have the same format and requirements as in `encode_witness`.
 */
export function encode_witness_htlc_multisig(sighashtype: SignatureHashType, private_key: Uint8Array, key_index: number, input_witness: Uint8Array, multisig_challenge: Uint8Array, transaction: Uint8Array, input_utxos: Uint8Array, input_index: number, additional_info: TxAdditionalInfo, current_block_height: bigint, network: Network): Uint8Array;
/**
 ...
 */
export function get_transaction_id(transaction: Uint8Array, strict_byte_size: boolean): string;
/**
 ...
 */
export function encode_output_produce_block_from_stake(pool_id: string, staker: string, network: Network): Uint8Array;
/**
 ...
 */
export function encode_output_issue_fungible_token(authority: string, token_ticker: string, metadata_uri: string, number_of_decimals: number, total_supply: TotalSupply, supply_amount: Amount | null | undefined, is_token_freezable: FreezableToken, _current_block_height: bigint, network: Network): Uint8Array;
/**
 ...
 */
export function encode_output_issue_nft(token_id: string, authority: string, name: string, ticker: string, description: string, media_hash: Uint8Array, creator: Uint8Array | null | undefined, media_uri: string | null | undefined, icon_uri: string | null | undefined, additional_metadata_uri: string | null | undefined, _current_block_height: bigint, network: Network): Uint8Array;
/**
 ...
 */
export function encode_output_htlc(amount: Amount, token_id: string | null | undefined, secret_hash: string, spend_address: string, refund_address: string, refund_timelock: Uint8Array, network: Network): Uint8Array;
/**
 ...
 */
export type SimpleCurrencyAmount = { coins: SimpleAmount } | { tokens: SimpleTokenAmount };
