 ...
 * @returns {Uint8Array}
 */
module.exports.make_receiving_address = function(private_key, key_index) {
 ...
 * @returns {Uint8Array}
 */
module.exports.make_change_address = function(private_key, key_index) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
module.exports.pubkey_to_pubkeyhash_address = function(public_key, network) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {Uint8Array}
 */
module.exports.extended_public_key_from_extended_private_key = function(private_key) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.make_receiving_address_public_key = function(extended_public_key, key_index) {
 ...
 * @returns {Uint8Array}
 */
module.exports.make_change_address_public_key = function(extended_public_key, key_index) {
    const ptr0 = passArray8ToWasm0(extended_public_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.sign_challenge = function(private_key, message) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(message, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {boolean}
 */
module.exports.verify_challenge = function(address, network, signed_challenge, message) {
 ...
 * @returns {Uint8Array}
 */
module.exports.make_transaction_intent_message_to_sign = function(intent, transaction_id) {
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_signed_transaction_intent = function(signed_message, signatures) {
 ...
 * @param {Network} network
 */
module.exports.verify_transaction_intent = function(expected_signed_message, encoded_signed_intent, input_destinations, network) {
 ...
 * @returns {Amount}
 */
module.exports.fungible_token_issuance_fee = function(_current_block_height, network) {
 ...
 * @returns {Amount}
 */
module.exports.nft_issuance_fee = function(current_block_height, network) {
 ...
 * @returns {Amount}
 */
module.exports.token_supply_change_fee = function(current_block_height, network) {
 ...
 * @returns {Amount}
 */
module.exports.token_freeze_fee = function(current_block_height, network) {
 ...
 * @returns {Amount}
 */
module.exports.token_change_authority_fee = function(current_block_height, network) {
 ...
 * @returns {string}
 */
module.exports.get_token_id = function(inputs, current_block_height, network) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
module.exports.get_order_id = function(inputs, network) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(inputs, wasm.__wbindgen_malloc);
 ...
 * @returns {string}
 */
module.exports.get_delegation_id = function(inputs, network) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(inputs, wasm.__wbindgen_malloc);
 ...
 * @returns {string}
 */
module.exports.get_pool_id = function(inputs, network) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(inputs, wasm.__wbindgen_malloc);
 ...
 * @returns {Amount}
 */
module.exports.data_deposit_fee = function(current_block_height, network) {
 ...
 * @returns {Uint8Array}
 */
module.exports.extract_htlc_secret = function(signed_tx, strict_byte_size, htlc_outpoint_source_id, htlc_output_index) {
 ...
 * @returns {number}
 */
module.exports.estimate_transaction_size = function(inputs, input_utxos_destinations, outputs, network) {
    const ptr0 = passArray8ToWasm0(inputs, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
module.exports.decode_signed_transaction_to_js = function(transaction, network) {
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_witness = function(sighashtype, private_key, input_owner_destination, transaction, input_utxos, input_index, additional_info, current_block_height, network) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_witness_htlc_secret = function(sighashtype, private_key, input_owner_destination, transaction, input_utxos, input_index, secret, additional_info, current_block_height, network) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(input_owner_destination, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    const ret = wasm.encode_witness_htlc_secret(sighashtype, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, input_index, ptr4, len4, additional_info, current_block_height, network);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v6 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_multisig_challenge = function(public_keys, min_required_signatures, network) {
 ...
 * @returns {string}
 */
module.exports.multisig_challenge_to_address = function(multisig_challenge, network) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_witness_htlc_multisig = function(sighashtype, private_key, key_index, input_witness, multisig_challenge, transaction, input_utxos, input_index, additional_info, current_block_height, network) {
    const ptr0 = passArray8ToWasm0(private_key, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    ...
    const len4 = WASM_VECTOR_LEN;
    const ret = wasm.encode_witness_htlc_multisig(sighashtype, ptr0, len0, key_index, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, input_index, additional_info, current_block_height, network);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v6 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_signed_transaction = function(transaction, signatures) {
    const ptr0 = passArray8ToWasm0(transaction, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_partially_signed_transaction = function(transaction, signatures, input_utxos, input_destinations, htlc_secrets, additional_info, network) {
    const ptr0 = passArray8ToWasm0(transaction, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(signatures, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
module.exports.decode_partially_signed_transaction_to_js = function(transaction, network) {
    const ptr0 = passArray8ToWasm0(transaction, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_destination = function(address, network) {
    const ptr0 = passStringToWasm0(address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
module.exports.get_transaction_id = function(transaction, strict_byte_size) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(transaction, wasm.__wbindgen_malloc);
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_token_transfer = function(amount, address, token_id, network) {
    _assertClass(amount, Amount);
    var ptr0 = amount.__destroy_into_raw();
    const ptr1 = passStringToWasm0(address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_token_lock_then_transfer = function(amount, address, token_id, lock, network) {
    _assertClass(amount, Amount);
    var ptr0 = amount.__destroy_into_raw();
    const ptr1 = passStringToWasm0(address, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_token_burn = function(amount, token_id, network) {
    _assertClass(amount, Amount);
    var ptr0 = amount.__destroy_into_raw();
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_produce_block_from_stake = function(pool_id, staker, network) {
    const ptr0 = passStringToWasm0(pool_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(staker, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_issue_fungible_token = function(authority, token_ticker, metadata_uri, number_of_decimals, total_supply, supply_amount, is_token_freezable, _current_block_height, network) {
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_issue_nft = function(token_id, authority, name, ticker, description, media_hash, creator, media_uri, icon_uri, additional_metadata_uri, _current_block_height, network) {
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_output_htlc = function(amount, token_id, secret_hash, spend_address, refund_address, refund_timelock, network) {
    _assertClass(amount, Amount);
    var ptr0 = amount.__destroy_into_raw();
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_create_order_output = function(ask_amount, ask_token_id, give_amount, give_token_id, conclude_address, network) {
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_mint_tokens = function(token_id, amount, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    _assertClass(amount, Amount);
    var ptr1 = amount.__destroy_into_raw();
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_unmint_tokens = function(token_id, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_lock_token_supply = function(token_id, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_freeze_token = function(token_id, is_token_unfreezable, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_unfreeze_token = function(token_id, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_change_token_authority = function(token_id, new_authority, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_change_token_metadata_uri = function(token_id, new_metadata_uri, nonce, network) {
    const ptr0 = passStringToWasm0(token_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_fill_order = function(order_id, fill_amount, destination, nonce, current_block_height, network) {
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_freeze_order = function(order_id, current_block_height, network) {
    const ptr0 = passStringToWasm0(order_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
module.exports.encode_input_for_conclude_order = function(order_id, nonce, current_block_height, network) {
    const ptr0 = passStringToWasm0(order_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @param {Network} network
 */
module.exports.internal_verify_witness = function(sighashtype, input_owner_destination, witness, transaction, input_utxos, input_index, additional_info, current_block_height, network) {
 ...
 * @enum {0 | 1}
 */
module.exports.FreezableToken = Object.freeze({
    No: 0, "0": "No",
    Yes: 1, "1": "Yes",
});
/**
 ...
 * @enum {0 | 1 | 2 | 3}
 */
module.exports.SignatureHashType = Object.freeze({
    ALL: 0, "0": "ALL",
    NONE: 1, "1": "NONE",
    SINGLE: 2, "2": "SINGLE",
 ...
 * @enum {0 | 1}
 */
module.exports.SourceId = Object.freeze({
 ...
 * @enum {0 | 1}
 */
module.exports.TokenUnfreezable = Object.freeze({
    No: 0, "0": "No",
    Yes: 1, "1": "Yes",
});
/**
