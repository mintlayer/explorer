...
export const HeadingBox = ({ subtitle, title, icon, info, progress, button, iconTooltip }: any) => {
  return (
    <div className="bg-white p-2 h-full flex items-center relative custom-homepage-heading-box-clip-path">
      <div className="px-2 py-1 md:py-2 flex items-center">
        ...
        {button ? (
          <Link href={button.link} className="bg-primary-100 text-white rounded absolute right-8 px-4 py-2">
            {button.label}
          </Link>
        ) : null}
      </div>
