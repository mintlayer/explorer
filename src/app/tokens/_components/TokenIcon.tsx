...
export const TokenIcon = ({ metadata_uri, metadata, ticker, size = 'small' }: any) => {
  ...
  return <>
    <div className={`${size === 'small' ? 'w-10 h-10' : 'w-16 h-16'} bg-gray-300 rounded-full overflow-hidden`}>
      {
        icon ? (
